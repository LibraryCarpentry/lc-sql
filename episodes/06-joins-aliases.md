...
We will cover [relational database design](08-database-design.md) in the next episode. In addition to visual above, *[SQL Join Types Explained Visually](https://www.atlassian.com/data/sql/sql-join-types-explained-visually)* provides visual/animated examples to help convey to learners what is happening in SQL `JOIN`s.
